# Generated by Django 5.2.4 on 2025-07-08 05:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faculty_photo', models.ImageField(default='default_profile.png', upload_to='profile_pictures/')),
                ('head_of_faculty', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='authorization.user')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_courses', models.PositiveIntegerField(default=48)),
                ('total_hours', models.PositiveBigIntegerField(default=260)),
                ('degree_type', models.CharField(choices=[('B', 'Bachelors'), ('M', 'Masters'), ('P', 'PhD')], default='B', max_length=1)),
                ('degree_image', models.ImageField(default='default.jpg', upload_to='degrees/')),
