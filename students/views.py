...
from authorization.models import Student, User, MailboxPost, MailboxReport, Comment, MailboxPostStatus, MailboxAdmin, Notification, NotificationType, UniversityDetails, SISForm
...
def sis_form(request):
    if request.mehtod == 'POST':
        ...
        return render(request, 'students/sis_form.html')   
